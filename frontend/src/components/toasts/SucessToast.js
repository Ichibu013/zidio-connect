...
/**
 * SuccessToast component displays a success message with an optional subtext.
 ...
 * @param {string} props.message - The main success message to display
 ...
 */
export default function SuccessToast({ message, subtext, show, onClose }) {
