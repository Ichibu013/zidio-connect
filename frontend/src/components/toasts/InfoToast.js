...
/**
 * InfoToast component displays an informational message with an optional subtext.
 ...
 * @param {string} props.message - The main informational message to display
 ...
 */
export default function InfoToast({ message, subtext, show, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="relative flex items-center p-6 bg-white rounded-xl border border-green-300 shadow-2xl max-w-sm w-full mx-4 animate-slideInRight"
        style={{
          boxShadow:
      ...
      >
        ...
        <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 mr-4 text-green-500 bg-green-100 rounded-full">
