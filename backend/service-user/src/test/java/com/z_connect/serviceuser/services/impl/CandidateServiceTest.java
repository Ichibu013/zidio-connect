...
import com.z_connect.serviceuser.dto.CandidateProfileDto;
import com.z_connect.serviceuser.dto.DisplayStatusDto;
import com.z_connect.serviceuser.dto.EducationDto;
import com.z_connect.serviceuser.dto.ProfileUpdateDto;
...
//    @Test
//    void getBasicCandidateDetails_shouldReturnMappedDto_whenUserExists() {
//        Users user = buildUser();
//        when(userRepository.findByEmail(email)).thenReturn(Optional.of(user));
//
...
//    }
    ...
    @Test
    void getBasicCandidateDetails_shouldThrow_whenProfileMissing() {
        Users user = buildUser();
        when(userRepository.findByEmail(email)).thenReturn(Optional.of(user));
        when(userProfileRepository.findByUser(user)).thenReturn(Optional.empty());
        assertThrows(ProfileNotFoundException.class, () -> candidateService.getBasicCandidateDetails());
    }
